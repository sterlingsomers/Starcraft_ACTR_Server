...
flags.DEFINE_integer("episodes", 30, "Number of complete episodes")
...
# (MINE) Define TIMESTEPS per episode (batch as each worker has its own episodes -- different timelines)
    ...
    history_file = 'history_x' + repr(file_name_count) + '.p'
    dict_dm_file = 'dict_dm_x' + repr(file_name_count) + '.p'
